function init() {
	...
	if (!gl) {
		...
		if (!gl.getProgramParameter(shaderProgram, gl.LINK_STATUS)) {
			...
			vertexBtn.addEventListener("click", function () { changeTool("vertex"); });
			lineBtn.addEventListener("click", function () { changeTool("line"); });
			squareBtn.addEventListener("click", function () { changeTool("square"); });
			rectangleBtn.addEventListener("click", function () { changeTool("rectangle"); });
			polygonBtn.addEventListener("click", function () { changeTool("polygon"); });
			pickerBtn.addEventListener("click", function () { changeTool("picker"); });
